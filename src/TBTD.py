...
def zdt1(LOWBOUNDS, UPBOUNDS, ind):
    ...
    gnm = numpy.array(gnm)
    obj1 = (gnm[0] * numpy.sqrt(16 + numpy.power(gnm[2], 2)) + gnm[1] * numpy.sqrt(1 + numpy.power(gnm[2], 2)))
    obj2 = (20 * numpy.sqrt(16 + numpy.power(gnm[2], 2))) / ((gnm[0] * gnm[2])+1e-16)
    result = [obj1, obj2]
    g1 = 0.1 - obj1
    g2 = 100000 - obj2
    g3 = 100000 - (0.8 * numpy.sqrt(1 + numpy.power(gnm[2], 2))) / (gnm[1] * gnm[2]+1e-16)
    conresult = [g1, g2, g3]
